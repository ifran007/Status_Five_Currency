...
class Turkish_TRY_Currency_History(BaseTest):


    def test_Search(self):
        self.data = Data
        self.driver.get(
            "https://www.exchangerates.org.uk/TRY-BDT-exchange-rate-history.html")  # url of EUR-BDT exchange
